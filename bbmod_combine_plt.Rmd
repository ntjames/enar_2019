...
#! nsims <- length(bb_sim_files) # don't need this
...
#doBatch(bb_sim_files_num[1:275], 100)
...
if (0){
ggplot(data=subset(bb_ci_dat,rho_2==0.35 & n==50),
...
ggplot(data=subset(bb_ci_dat,rho_2==0.35 & n==100),
       aes(x=q0.5, xmin=q0.05, xmax=q0.95, y=outcome, color=model)) +   
  geom_linerangeh(position=position_dodgev(height=0.4), size=2, alpha=0.15) +
  facet_grid(delta_e~delta_s,labeller = "label_both")

ggplot(data=subset(bb_ci_dat,rho_2==0.35 & n==200),
       aes(x=q0.5, xmin=q0.05, xmax=q0.95, y=outcome, color=model)) +   
  geom_linerangeh(position=position_dodgev(height=0.4), size=2, alpha=0.15) +
  facet_grid(delta_e~delta_s,labeller = "label_both")
...
bb_ci_n100_1 <- ggplot(data=subset(bb_ci_dat, rho_2==0.1 & n==100),
            aes(x=q0.5, xmin=q0.05, xmax=q0.95, y=outcome, color=model)) +   
          geom_linerangeh(position=position_dodgev(height=0.4), size=2, alpha=0.15) +
          facet_grid(delta_e~delta_s, labeller = "label_both")
...
bb_ci_n100_2 <- ggplot(data=subset(bb_ci_dat, rho_2==0.35 & n==100), 
            aes(x=q0.5, xmin=q0.05, xmax=q0.95, y=outcome, color=model)) +   
          geom_linerangeh(position=position_dodgev(height=0.4), size=2, alpha=0.15) +
          facet_grid(delta_e~delta_s, labeller = "label_both")

bb_ci_n100_3 <- ggplot(data=subset(bb_ci_dat, rho_2==0.6 & n==100), 
